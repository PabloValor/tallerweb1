...
public final class agregarDescuentos_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<h2>\r\n");
      out.write("\t\t\t\tCarrito <span class=\"glyphicon glyphicon-shopping-cart\" aria-hidden=\"true\"></span> - <small>Agregar descuentos</small>\r\n");
      out.write("\t\t\t</h2>\r\n");
      out.write("\t\t\t<table class=\"table table-striped\">\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>Agregar Descuento:</td>\r\n");
      out.write("\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t<td>Aplicar</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<form action=\"insertarDescuento\" method=\"POST\">\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>Porcentaje de Descuento:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"text\" name=\"porcentaje\" value=\"\" id=\"porcentaje\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"submit\" value=\"Agregar\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</form>\t\t\r\n");
      out.write("\t\t\t\t\t<form action=\"insertarDescuento\" method=\"POST\">\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>Monto de Descuento:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"text\" name=\"monto\" value=\"\" id=\"monto\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"submit\" value=\"Agregar\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t</table>\r\n");
  ...
  private boolean _jspx_meth_c_005furl_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/agregarDescuentos.jsp(25,34) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
